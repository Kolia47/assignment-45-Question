...
let california_pizza = ["chicken_tikka", "chicken_cheese", "fajita_sicilian"];
for (let top of california_pizza) {
    console.log(top);
}
for (let top of california_pizza) {
    console.log("I like " + top);
}
console.log("\nthe smells and taste of chickken tikka pizza is fabolous,");
console.log("chicken cheese pizza is gooey and crispy,");
console.log("sicilon pizza is thick-crusted and garnish with onion, herbs, tomatos, and strong cheese ");
